(()=>{
  ...
  function css(){
    ...
    document.head.insertAdjacentHTML('beforeend','<style id="footerContactOverlayStyles">#story.footer-composite{position:relative!important;isolation:isolate;overflow:hidden}#story.footer-composite .footer-contact-overlay{position:absolute!important;z-index:3;inset:auto 0 0 0!important;width:100%!important;max-width:none!important;min-width:0!important;margin:0!important;padding:16px max(5vw,28px);background:linear-gradient(90deg,#24180ee8,#3a2517c4);color:#fff9ed;display:grid;gap:9px}#story.footer-composite .footer-contact-list{display:flex;align-items:center;gap:20px;flex-wrap:wrap;font-size:13px}#story.footer-composite .footer-contact-list a{color:inherit;text-decoration:none;white-space:nowrap}#story.footer-composite .footer-social-list{display:flex;align-items:flex-start;gap:10px;flex-wrap:wrap}.footer-social-item{position:relative}.footer-social-toggle{border:1px solid #fff8e099;background:#ffffff18;color:#fff9ed;padding:6px 10px;cursor:pointer;font:12px inherit}.footer-social-toggle[aria-expanded=true]{background:#ffffff32}.footer-social-qr{position:absolute;z-index:4;left:0;bottom:calc(100% + 8px);width:126px;padding:7px;background:#fffdf8;border:1px solid #e4d8c6;box-shadow:0 8px 22px #0005}.footer-social-qr img{display:block;width:100%;height:auto;aspect-ratio:1;object-fit:contain}.footer-social-qr[hidden]{display:none}@media(max-width:780px){#story.footer-composite{aspect-ratio:4/3}#story.footer-composite .footer-contact-overlay{padding:12px 7vw;gap:8px}#story.footer-composite .footer-contact-list{display:flex;flex-direction:row;align-items:center;gap:12px;flex-wrap:nowrap;overflow-x:auto;font-size:12px}#story.footer-composite .footer-social-list{gap:6px;flex-wrap:nowrap;overflow-x:auto}.footer-social-toggle{padding:5px 8px;font-size:11px}}</style>');
  }
