...
(() => {
  ...
  function injectStyle() {
    ...
    @media(min-width:721px){#settings:has(#storeProfileSlot .store-settings-pane.active) .panel.narrow{padding-top:0;padding-bottom:15px}#storeNameRow{height:75px;margin-top:-20px}#storeNameRow+.store-settings-row{height:75px;margin-top:0}#storeProfileSlot .store-settings-pane input{box-sizing:border-box;height:40px}#storeProfileSlot .store-settings-row label{margin:6px 0}#storeProfileSlot .store-settings-pane label:has(#storeAddressInput){box-sizing:border-box;height:75px;padding:5px 0;margin:0}#storeProfileSlot .store-settings-pane label:has(#storeIntroInput){margin:3px 0 15px}#storeProfileSlot #storeIntroInput{height:75px;min-height:75px;margin-top:5px;margin-bottom:-15px}}
