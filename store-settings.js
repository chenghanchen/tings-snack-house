...
(() => {
  ...
  function injectStyle() {
    ...
    #settings{width:min(650px,100%)}#settings .panel.narrow{width:100%;max-width:none!important;border-radius:10px}.store-settings-layout{margin-top:22px}.store-settings-pane{display:none}.store-settings-pane.active{display:block}.store-pane-heading{margin-bottom:19px}.store-pane-heading h3{font:700 23px Arial, sans-serif;margin:0}.store-pane-heading .muted{margin:7px 0 0}.store-settings-pane label{display:block;margin:14px 0;font-size:12px;font-weight:700}.store-settings-pane input,.store-settings-pane textarea,.store-settings-pane select{width:100%;margin-top:7px}.store-settings-pane textarea{min-height:74px;resize:vertical}.store-settings-row,.order-rule-row{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.store-settings-row label{min-width:0}.store-settings-pane[data-store-pane="order"]{font-size:14px}.store-settings-pane[data-store-pane="order"] label,.store-settings-pane[data-store-pane="order"] .rule-switch{font-size:14px}.store-settings-pane[data-store-pane="order"] h4{font-size:14px}.store-save{margin-top:18px;border-radius:10px}.store-mobile-back{display:none}#settingsForm>.store-legacy-source{display:none!important}.hours-table{width:100%;border-collapse:collapse;margin:15px 0}.hours-table th,.hours-table td{border-bottom:1px solid #eee9df;padding:6px 8px;text-align:left;font-size:14px}.hours-table th{color:#6d7972;font-size:14px}.hours-table label{margin:0;font-size:14px;line-height:1.25}.hours-table input[type="checkbox"],.rule-switch input{width:auto;margin:0 7px 0 0}.hours-table input[type="time"]{display:inline-block;width:108px;margin:0;padding:6px 7px;font-size:14px}.special-hours{display:grid;gap:8px;margin-top:10px}.special-hour-row{display:grid;grid-template-columns:135px 90px 1fr 1fr minmax(120px,1.4fr) auto;gap:7px;align-items:end;padding:9px;border:1px solid #e7e0d4;background:#fffdf8}.special-hour-row input,.special-hour-row select{margin:0;padding:8px}.special-hour-row button{border:0;background:transparent;color:var(--red);cursor:pointer;padding:8px}.add-special{margin-top:10px}.rule-list{display:grid;gap:6px;margin:10px 0}.rule-switch{display:flex;align-items:center;gap:3px;padding:6px 10px;border:1px solid var(--line);background:#fffdf8;font-size:12px;cursor:pointer}.store-settings-pane .rule-switch{margin:0}.rule-switch small{margin-left:auto;color:#758077;font-weight:400}.settings-inline-note{margin:8px 0 0;font-size:11px;color:#728077;line-height:1.7}.store-proxy-label{margin:0}.store-settings-pane .two{margin:0}.notification-test{margin-top:10px;border:1px solid var(--line);background:#fffdf8;color:var(--red);padding:8px 11px;cursor:pointer}.notification-heading{display:flex;align-items:center;gap:12px}.notification-heading h4{margin:0}.notification-heading .notification-test{box-sizing:border-box;height:30px;margin:0;border-radius:15px;padding:0 10px}.notification-controls{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px 12px;align-items:center;margin-top:10px}.notification-controls>#alertsSlot,.notification-controls #newOrderAlertSettings{display:contents}.notification-controls #newOrderAlertSlot{grid-column:1;grid-row:1}.notification-controls #newOrderAlertSettings>label{grid-column:1/-1;grid-row:2;margin:0}.notification-controls .notification-sound-toggle{box-sizing:border-box;grid-column:2;grid-row:1;width:100%;height:38.75px;margin:0!important;padding:10px}.notification-alert-toggle{box-sizing:border-box;width:100%;height:38.75px;margin:0!important;padding:10px}.store-settings-submenu{display:none;gap:3px;margin:-3px 0 4px 12px;padding-left:10px;border-left:1px solid #ffffff2b}.store-settings-submenu.open{display:grid}.store-settings-submenu button{font-size:12px!important;padding:9px 10px!important}.store-settings-submenu button.active{background:#ffffff16;color:#fff}.settings-parent-toggle{position:relative;padding-right:32px!important}.settings-parent-toggle::after{content:'›';position:absolute;right:12px;font-size:17px;line-height:1;transition:transform .18s}.settings-parent-toggle.expanded::after{transform:rotate(90deg)}
    @media(min-width:721px){#settings:has(#storeProfileSlot .store-settings-pane.active) .panel.narrow,#settings:has(#storeDeliverySlot .store-settings-pane.active) .panel.narrow,#settings:has(#storeOrderSlot .store-settings-pane.active) .panel.narrow,#settings:has(#storeNotificationSlot .store-settings-pane.active) .panel.narrow{padding-top:0;padding-bottom:15px}#storeNameRow{height:75px;margin-top:-20px}#storeNameRow+.store-settings-row{height:75px;margin-top:0}#storeProfileSlot .store-settings-pane input{box-sizing:border-box;height:40px}#storeProfileSlot .store-settings-row label{margin:6px 0}#storeProfileSlot .store-settings-pane label:has(#storeAddressInput){box-sizing:border-box;height:75px;padding:5px 0;margin:0}#storeProfileSlot .store-settings-pane label:has(#storeIntroInput){margin:3px 0 15px}#storeProfileSlot #storeIntroInput{height:75px;min-height:75px;margin-top:5px;margin-bottom:-15px}#storeDeliverySlot .store-settings-row,#storeDeliverySlot #deliveryPriceSlot{height:75px}#storeDeliverySlot .store-settings-row label,#storeDeliverySlot #deliveryPriceSlot label{margin:6px 0}#storeOrderSlot #requiredFieldRules{margin-top:-10px}#storeOrderSlot .store-settings-pane>.order-rule-row{margin-top:-10px}#storeOrderSlot #orderPriceSlot{box-sizing:border-box;height:83px;margin-top:-12px}#storeOrderSlot #orderPriceSlot label{margin:10px 0}}
    @media(max-width:720px){#settings{width:100%}#settings:has(#storeProfileSlot .store-settings-pane.active) .panel.narrow{padding-top:0;padding-bottom:15px}#settings:has(#storeHoursSlot .store-settings-pane.active) .panel.narrow,#settings:has(#storeDeliverySlot .store-settings-pane.active) .panel.narrow,#settings:has(#storeOrderSlot .store-settings-pane.active) .panel.narrow,#settings:has(#storeNotificationSlot .store-settings-pane.active) .panel.narrow{padding-top:0}.store-settings-layout{margin-top:16px}.store-settings-row,.order-rule-row{grid-template-columns:1fr}.special-hour-row{grid-template-columns:1fr 1fr;gap:8px}.special-hour-row input[name="specialNote"]{grid-column:1/-1}.special-hour-row button{grid-column:2;justify-self:end}.hours-table{display:block;overflow:auto}.hours-table th,.hours-table td{white-space:nowrap;padding:6px 5px}.hours-table input[type="time"]{width:92px}.store-save{width:100%}.store-settings-submenu{margin:0 0 4px 5px}.store-settings-submenu button{padding:8px 10px!important}#storeProfileSlot .store-settings-pane label,#storeDeliverySlot .store-settings-pane label{margin:10px 0}#storeProfileSlot .store-settings-row{gap:0}#storeProfileSlot .store-settings-pane label{margin:5px 0}#storeProfileSlot .store-settings-pane input{box-sizing:border-box;height:40px}#storeProfileSlot .store-settings-pane label:has(#storeAddressInput){box-sizing:border-box;height:75px;padding:5px 0;margin:0}#storeProfileSlot .store-settings-pane label:has(#storeIntroInput){margin:3px 0 15px}#storeDeliverySlot .store-settings-row,#storeDeliverySlot .two,#storeOrderSlot .order-rule-row,#storeOrderSlot .two{grid-template-columns:1fr;gap:0}#storeOrderSlot #requiredFieldRules .order-rule-row{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}#storeDeliverySlot .store-settings-pane label:not(.rule-switch),#storeOrderSlot .store-settings-pane label:not(.rule-switch),#storeNotificationSlot .store-settings-pane label:not(.rule-switch){margin:5px 0}}
  </style>`,
    );
    document.head.insertAdjacentHTML(
      "beforeend",
      `<style id="storeHoursLayoutStyles">
        @media(min-width:721px){
          ...
          #storeHoursSlot .hours-special-heading{display:flex;align-items:center;justify-content:flex-start;gap:12px;margin-top:10px}
          #storeHoursSlot .hours-special-heading h4{margin:0}
          #storeHoursSlot .add-special{width:110px;height:25px;margin-top:0;margin-right:clamp(0px,calc(100% - 265px),335px);border:1.25px solid var(--line);border-radius:10px;background:#fffdf8;color:var(--red);padding:0;font:12px Arial, sans-serif}
  ...
  function build() {
    ...
    if (!$("#storeSettingsLayout")) {
      ...
      $("#storeDeliverySlot").innerHTML = pane(
        ...
        "配送与自取",
        "设置配送门槛、配送说明及到店自取信息。",
        `<div class="store-settings-row">${label("最低消费金额", "minOrderInput", "number", 'min="0" step="0.01"')}${label("最低配送金额", "minDeliveryInput", "number", 'min="0" step="0.01"')}</div><div class="two" id="deliveryPriceSlot"></div><label class="store-proxy-label">配送说明<textarea id="deliveryCopyInput" rows="3"></textarea></label><div id="pickupSlot"></div>`,
      );
      ...
      $("#storeNotificationSlot").innerHTML = pane(
        ...
        "通知设置",
        "选择新订单到达时的提醒方式。",
        `<div class="notification-heading"><h4>新订单提醒</h4><button class="notification-test" type="button" data-test-notification>测试通知</button></div><div class="notification-controls"><div id="alertsSlot"></div><label class="rule-switch notification-sound-toggle"><input id="notificationSoundInput" type="checkbox">播放新订单提示音</label></div>`,
      );
