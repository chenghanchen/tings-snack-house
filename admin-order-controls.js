...
(() => {
  ...
  let alertEnabled = localStorage.getItem("tings-new-order-alerts") === "on",
    ...
    filterTimer;
  const css = `
    #orders .panel{padding:18px 24px}#orders .panel-head{min-height:0;padding:0 0 8px;margin-bottom:0}.order-tab-heading{min-height:0}.order-tabs{gap:8px}.order-tab{width:130px;height:50px;padding:10px 15px;font-size:14px}.shop-status-option{padding:10px 15px;font-size:14px}
    #orderDateControls{display:flex;align-items:center;gap:18px;margin:0 0 0 14px;flex-wrap:nowrap}.order-date-label{white-space:nowrap;color:#000;font:700 15px "Noto Serif SC",serif}.order-date-filter{position:relative;display:flex;align-items:center;gap:8px;flex-wrap:nowrap}.order-date-field{margin:0;font-size:13px;font-weight:700;color:#68746c}.order-date-field select,.order-date-field input{margin-top:3px;min-width:170px;padding:10px 12px;font-size:14px}.order-date-range{display:flex;align-items:center;gap:6px;flex-wrap:nowrap;font-size:15px;color:#758077}.order-date-range input{width:130px;min-width:130px;margin:0;padding:6px 8px;font-size:15px}.order-date-range[hidden]{display:none!important}.order-date-empty{margin:16px 0 0;color:#758077;font-size:12px}.order-search{margin:11px 0}.new-order-alert-settings{border-bottom:1px solid var(--line);padding:0 0 20px;margin:0 0 20px}.new-order-alert-settings h3{margin:0 0 12px;font-family:"Noto Serif SC";font-size:18px}.new-order-alert-settings .text-btn{border:1px solid var(--line);background:#fffdf8;padding:8px 10px}.new-order-alert-settings .text-btn.enabled{background:#6caa70;border-color:#6caa70;color:white}.new-order-alert-settings label{margin:14px 0 0}#orderDatePreset{width:170px;min-width:170px;height:35px;margin:0;padding:7px 28px 7px 9px;border-radius:15px;font-size:15px}
    @media(min-width:721px){#orderDateControls{flex-wrap:nowrap}.order-date-range{flex-wrap:nowrap}.order-date-field select{width:185px;min-width:185px}.order-date-range .order-date-field{width:185px}.order-date-range .order-date-field input{width:100%;min-width:0}}
    @media(max-width:720px){#orders .panel{padding:16px}.order-tab-heading{flex-wrap:wrap}.order-tab{width:auto;height:auto;padding:10px 13px;font-size:14px}.shop-status-option{padding:9px 12px;font-size:13px}#orderDateControls{position:relative;width:100%;gap:8px;margin:12px 0 0;align-items:center;flex-wrap:wrap}.order-date-label{font:700 16px "Noto Serif SC",serif}.order-date-filter{display:contents}.order-date-range{position:static;z-index:auto;flex-basis:100%;justify-content:center;margin:5px 0;transform:none;background:transparent;gap:6px;white-space:nowrap;font-size:15px}.order-date-range input{width:126px;min-width:0;padding:6px 8px;font-size:16px}#orderDatePreset{width:150px;min-width:150px;height:36px;margin:0;padding:7px 28px 7px 9px;font-size:16px}.order-date-field select,.order-date-field input{min-width:0;padding:9px 10px;font-size:13px}#orderDateControls:has(.order-date-range:not([hidden])){padding-bottom:0}}
  `;
